...
- `references/architecture.md` — 架构速览：包结构、核心对象、高影响模块、改动检查清单
- `references/docs-map.md` — 文档映射与常见任务执行手册
- `references/chrome-devtools-mcp.md` — Chrome DevTools MCP 协作与接入说明
- `references/bundled-materials.md` — 本文件，已打包资料清单

## 已复制的 docs_en 资料（英文文档，共 16 个文件）
...
- `references/docs_en/get_start/`（6 个文件，含 examples/ 子目录）
...
## 已复制的 docs_zh 资料（中文文档，共 77 个文件）

- `references/docs_zh/README.md`
- `references/docs_zh/index.json`
- `references/docs_zh/入门指南/`（10 个文件，含 README.md）— 安装、导入、基本概念、准备工作、设置语言、常见问题、收发数据包、模式切换、自动登录
- `references/docs_zh/控制浏览器/`（33 个文件，含 README.md）— 连接浏览器、Page 对象、元素交互、定位语法、标签页管理、截图录像、监听网络数据、动作链、等待、iframe 操作、指纹浏览器等
- `references/docs_zh/SessionPage/`（9 个文件，含 README.md）— 创建页面对象、启动配置、查找元素、获取元素/页面信息、访问网页、页面设置
